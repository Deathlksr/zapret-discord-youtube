...
start "zapret: general (ALT0)" /min "%BIN%winws.exe" --wf-tcp=80,443,2099,8095,9000 --wf-udp=443,50000-50100 ^
...
--filter-tcp=9000 --ipset="%LISTS%ipset-ea.txt" --dpi-desync=syndata --dpi-desync-autottl=4